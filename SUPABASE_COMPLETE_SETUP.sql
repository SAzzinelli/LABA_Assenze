-- =====================================================
-- SETUP COMPLETO DATABASE SISTEMA HR LABA
-- COPIA E INCOLLA QUESTO IN SUPABASE SQL EDITOR
-- =====================================================

-- 1. TABELLA SETTINGS (impostazioni utente)
...
-- 3. TABELLA LEAVE_BALANCES (saldi ferie/permessi)
...
-- 4. TABELLA DEPARTMENTS (dipartimenti)
...
-- 5. TABELLA NOTIFICATIONS (notifiche)
...
-- 9. TABELLA AUDIT_LOGS (log delle azioni)
