...
async def run_test():
    ...
    try:
        ...
        # Click the 'Registrati' button to go to the registration page.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div[2]/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill all required fields on step 1 with valid data and click 'Avanti' (index 14) to proceed.
        frame = context.pages[-1]
        ...
        # Fill all required fields on step 3 with valid data and click 'Avanti' (index 10) to proceed.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div[2]/div[2]/form/div/div[2]/div[2]/input').nth(0)
        ...
        # Click the 'Completa Registrazione' button (index 5) to submit the registration and verify successful registration and redirection.
        frame = context.pages[-1]
