...
async def run_test():
    ...
    try:
        ...
        # Click on 'Registrati' button to go to registration page to register a new user.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div[2]/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Try to input date of birth using keyboard keys or skip date input and submit the form to register user.
        frame = context.pages[-1]
        ...
        # Try to input hire date using keyboard keys after focusing the date field, then select workplace and contract type dropdowns, and click 'Avanti' to proceed.
        frame = context.pages[-1]
        ...
        # Click 'Completa Registrazione' button to submit registration and create the user.
        frame = context.pages[-1]
